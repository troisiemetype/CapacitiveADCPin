...
#include "CapacitiveADCCore.h"

CapacitiveADCCore *CapacitiveADCCore::_singleton = NULL;


// Public methods

// Getter for singleton instance
static CapacitiveADCCore* CapacitiveADCCore::getInstance(){
	if(_singleton == NULL){
		_singleton = new CapacitiveADCCore();
	}
	return _singleton;
}

// Killer for singleton instance
// Should never be used!
void CapacitiveADCCore::killInstance(){
	if(_singleton != NULL){
		delete _singleton;
		_singleton = NULL;
	}
